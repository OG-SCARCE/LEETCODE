...
> **Related Topics** : **[Array](<by_topic/Array.md>), [Hash Table](<by_topic/Hash Table.md>), [Enumeration](<by_topic/Enumeration.md>)**
>
...
- [3804-maximize-active-section-with-trade-ii/solution.java](<../solutions/3804-maximize-active-section-with-trade-ii/solution.java>)
### Java
#### [solution.java](<../solutions/3804-maximize-active-section-with-trade-ii/solution.java>)
```Java
class Solution {
